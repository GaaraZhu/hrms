; (function ($) {
	...
	$.lPaging = function (el,options) {
		...
		var totalPage=Number(options.totalPage);
		var countSize=Number(options.countSize);
		...
		self.init = function () {
			...
			if(pageNumber!=1){
			    ...
			    ul+="<li><a href='javascript:;' pv='1'>首页</a></li>";
                ul+="<li><a href='javascript:;' pv='1'>上一页</a></li>";
			}
			...
			if(pageNumber<totalPage){
			    ...
			    ul+="<li><a href='javascript:;' pv='"+(totalPage)+"'>下一页</a></li>";
                ul+="<li><a href='javascript:;' pv='"+totalPage+"'>尾页</a></li>";
			}
