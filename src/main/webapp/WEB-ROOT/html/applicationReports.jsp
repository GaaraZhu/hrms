		...
		<form class="form-inline" role="form" id="selectApplicationReportVal">
                <div class="row">
                    <div class="form-group inputselect col-lg-4">
                        ...
                        <input type="text" class="form-control hasDatepicker" id="searchFromDate" name="searchFromDate" placeholder="开始日期" readonly="readonly">
                    </div>
                    <div class="form-group inputselect col-lg-4">
                        <label for="searchToDate">结束日期</label>
                        <input type="text" class="form-control hasDatepicker" id="searchToDate" name="searchToDate" placeholder="结束日期" readonly="readonly">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group inputselect col-lg-4">
