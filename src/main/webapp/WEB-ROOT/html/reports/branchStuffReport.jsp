...
<body class="full" id="content">
    <script src="<%=request.getContextPath()%>/WEB-ROOT/js/branchStuffReport.js"></script>
    <script src="<%=request.getContextPath()%>/WEB-ROOT/bootstrap/js/jquery.canvasjs.min.js"></script>
	<div id="innerModal"></div>
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12">
		<form class="form-inline" role="form" id="selectBranchStuffReportVal">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group inputselect col-lg-4">
                        <button type="button" class="btn btn-success btn-sm " id="branchStuffReportAnalysis">
                            <span class="glyphicon glyphicon-signal"></span> 在职数据分析
                        </button>
                    </div>
                    <div class="form-group inputselect">
                        <button type="button" class="btn btn-success btn-sm " id="searchBranchStuffReport" style="margin-left: 192px;">
                            <span class="glyphicon glyphicon-search"></span> 搜索
                        </button>
                        <button type="button" class="btn btn-success btn-sm " id="resetBranchStuffReport">
			...
			<div class="table-responsive " style="margin-left: 3%;">
				<table class="table table-hover tablefont">
					<tbody id="branchStuffReportTableList"/>
				</table>
                <div id="branchStuffReportAnalysisDiv" style="bottom: 10%; margin-left: 32%;">
                    请输入条件查询在职数据，并进行进行图表分析
                </div>
			</div>
