							...
							<div class="form-group " >
                                <div class="row">
                                    ...
                                    <div class="col-lg-35" style="padding-top: 25px;">
                                        <select id="companyId" name="companyId" style="width: 202px;height: 32px;"></select>
                                    </div>
                                    <label for="name" class="col-lg-2 control-label" style="padding-top: 30px;">职位名称</label>
                                    <div class="col-lg-35" style="padding-top: 25px;">
                                        <input type="text" class="form-control col-lg-35" name="name" id="name" placeholder="请输入职位名称">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-35" style="padding-top: 25px;">
                                        <input type="text" class="form-control col-lg-35" name="salaryRange" id="salaryRange" placeholder="请输入薪资待遇">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-35" style="padding-top: 25px;">
                                        <input type="text" class="form-control col-lg-35" name="referralBonusAmount" id="referralBonusAmount" placeholder="请输入奖励金额">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-35" style="padding-top: 25px;">
                                        <input type="text" class="form-control col-lg-35" name="note" id="note" placeholder="请输入备注">
                                    </div>
                                </div>
